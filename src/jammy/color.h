...
inline jm_color32 jm_pack_color32_rgba_u8(
	uint8_t r,
	uint8_t g,
	uint8_t b,
	uint8_t a)
...
inline jm_color32 jm_pack_color32_rgba_f32(
	float r,
	float g,
	float b,
	float a)
...
inline void jm_unpack_color32_rgba_u8(
	jm_color32 color,
	uint8_t* r,
	uint8_t* g,
	uint8_t* b,
...
inline void jm_unpack_color32_rgba_f32(
	jm_color32 color,
	float* r,
	float* g,
	float* b,
